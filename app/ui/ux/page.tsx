...
async function getData() {
    const query = `*[_type == 'uiux']  | order(_createdAt desc) [0...8] {
        title,
          _id,
          link,
          description,
    ...
    return (
      <section className="max-w-7xl w-full px-4 md:px-8 mx-auto">
        ...
        <p className="leading-7 text-muted-foreground mt-2">
          Check out what projects I have created in figma 🌐⚡🧑🏻‍💻
        </p>
        <div className="py-12 grid md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12 grid-cols-1">
          {data.map((item) => (
            <a
              ...
              target="_blank"
            >
              <div className="aspect-w-16 aspect-h-12 overflow-hidden rounded-2xl relative border-blue-600">
                <Image
                  src={item.imageUrl}
