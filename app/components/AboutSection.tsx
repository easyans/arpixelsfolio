    ...
    <div className="grid gird-cols-1 lg:grid-cols-3 gap-4 mt-10">
      <Card className="col-span-1 lg:col-span-2 border-none bg-gray-100 p-8">
        <h1 className="text-4xl lg:text-5xl">
          Passionate <span className="text-blue-600	">UI/UX</span> Designer who loves to create interactive designs.
        </h1>
        <p className="mt-4 text-muted-foreground lg:text-lg text-justify">
          I am a Computer Science engineer with a passion for creating efficient and
          user-friendly UI Designs, website,and iOS applications. I have experience in developing
          ...
          user-friendly UI designs that solve real-world problems.
        </p>
